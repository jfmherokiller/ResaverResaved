 ...
 */
enum class Opcode(val ARGS: Int) {
    NOP(0),  // 0    00
    IADD(3),  // 1    01
    FADD(3),  // 2    02
    ISUB(3),  // 3    03
    ...
    val isConditional: Boolean
        get() = this == JMPT || this == JMPF
    val isBranching: Boolean
        get() = this == JMPT || this == JMPF || this == JMP
    val isArithmetic: Boolean
        get() = this == IADD || this == FADD || this == ISUB || this == FSUB || this == IMUL || this == FMUL || this == IDIV || this == FDIV || this == IMOD

    /**
     * @return A flag indicating whether the `Opcode` takes a
     * variable number of arguments.
     */
    fun hasExtraTerms(): Boolean {
        return ARGS < 0
    }
     ...
     */
    val fixedCount: Int
        get() = if (hasExtraTerms()) 1 - ARGS else ARGS
    ...
    companion object {
        ...
        fun read(input: PlatformByteBuffer): Opcode {
