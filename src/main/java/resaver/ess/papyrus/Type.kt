...
enum class Type(private val VALID: Boolean = true) : PapyrusElement {
    NULL, REF, STRING, INTEGER, FLOAT, BOOLEAN, VARIANT, STRUCT, INVALID_8(false), INVALID_9(false), INVALID_10(false), REF_ARRAY, STRING_ARRAY, INTEGER_ARRAY, FLOAT_ARRAY, BOOLEAN_ARRAY, VARIANT_ARRAY, STRUCT_ARRAY;
