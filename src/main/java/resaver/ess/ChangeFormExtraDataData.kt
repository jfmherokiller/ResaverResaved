 ...
 */
class ChangeFormExtraDataData(input: ByteBuffer, context: ESSContext) : GeneralElement() {
    /**
    ...
    private class AliasInstance internal constructor(input: ByteBuffer?, context: ESSContext?) : GeneralElement() {
        init {
    ...
    private class MagicTarget internal constructor(input: ByteBuffer?, context: ESSContext?) : GeneralElement() {
        init {
            super.readRefID(input, "REF", context)
