...
class RemappingStats {
    ...
    override fun toString(): String {
        return "Processed $scripts scripts.\n" +
                "Renamed ${objectVariables - conditionals} object variables.\n" +
                "${autovars - conditionals} of them were property autovariables.\n" +
                "Skipped $conditionals conditional autovariables.\n" +
                "Processed $functions functions.\n" +
                "Renamed ${localVariables} function local variables.\n" +
                "Renamed $parameters function parameters.\n" +
                "Stripped $docStrings docstrings.\n"
    }
